...
const IconOverview = () => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <line x1="5.5" y1="2.5" x2="5.5" y2="4.5"/>
...
const IconRebalance = () => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M3 5h7M8 3l2 2-2 2"/>
    <path d="M13 11H6M8 13l-2-2 2-2"/>
  </svg>
)
const IconAdmin = () => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div style={S.app}>
        ...
        <div style={S.main}>
          ...
          <div
            ...
            style={{ height: 6, background: '#b0bac8', cursor: 'ns-resize', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', userSelect: 'none' }}
          >
