...
export function PlaylistManager({ accessToken, onAuthError }: PlaylistManagerProps) {
  ...
  const S: Record<string, React.CSSProperties> = {
    ...
    addBtn: { padding: '0 10px', background: '#0071e3', borderRadius: 5, fontSize: 12, color: 'white', border: 'none', cursor: 'pointer', height: 24, lineHeight: '24px' },
    removeBtn: { padding: '0 10px', background: '#e8e8ed', borderRadius: 5, fontSize: 12, color: '#444', border: '0.5px solid #ccc', cursor: 'pointer', height: 24, lineHeight: '24px' },
